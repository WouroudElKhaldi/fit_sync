...
export default function VerifyResetCodeScreen({ navigation, route }: Props) {
  ...
  // Simulated resend countdown timer
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      ...
      // Code is valid - forward to ResetPassword step
      ...
      >
        <View className="w-full max-w-[400px] align-self-center mx-auto flex flex-col gap-4">
          ...
          >
            ...
            <Text className="font-bold text-[14px]" style={{ color: colors.primary }}>Edit Email Address</Text>
          </TouchableOpacity>
