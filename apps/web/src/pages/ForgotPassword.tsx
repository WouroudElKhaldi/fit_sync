...
const ForgotPassword: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(err.message || 'An error occurred while requesting reset code. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    >
      ...
      <div className="w-full max-w-[450px] z-10 flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="text-sm font-semibold text-white/70 drop-shadow-sm">Reset Secure Athlete Password</p>
        </div>
